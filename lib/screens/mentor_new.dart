...
class YourMentor extends StatefulWidget {
  YourMentor({Key? key}) : super(key: key);

  @override
  State<YourMentor> createState() => _YourMentorState();
}

class _YourMentorState extends State<YourMentor> {
  // int currentStep = 0;
  // dynamic titleName ;
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        // child:  Text('Rank:237',style: TextStyle(fontWeight: FontWeight.bold),), ),
          ...
          //    Navigator.push(context, MaterialPageRoute(builder: (context) => GroupElite24(),));
          //                     },
          //    child: Padding(
