...
class Course24Mentors extends StatefulWidget {
  Course24Mentors({Key? key}) : super(key: key);

  @override
  State<Course24Mentors> createState() => _Course24MentorsState();
}

class _Course24MentorsState extends State<Course24Mentors> {
  // int currentStep = 0;
  // dynamic titleName ;
