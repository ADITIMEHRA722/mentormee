...
class ElitePlusBt23 extends StatefulWidget {
  ElitePlusBt23({Key? key}) : super(key: key);

  @override
  State<ElitePlusBt23> createState() => _EliteBt23State();
}

class _EliteBt23State extends State<ElitePlusBt23> {
  // int currentStep = 0;
  // dynamic titleName ;
          ...
          SizedBox(height: 20,),
           ...
           InkWell(
            onTap: (){
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context) => EliteBtAddForElitePlus(),));
                              },
             child: Padding(
