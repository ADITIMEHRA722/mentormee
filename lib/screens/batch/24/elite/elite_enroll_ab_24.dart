...
class EliteBt24 extends StatefulWidget {
  EliteBt24({Key? key}) : super(key: key);

  @override
  State<EliteBt24> createState() => _EliteBt23State();
}

class _EliteBt23State extends State<EliteBt24> {
  // int currentStep = 0;
  // dynamic titleName ;
          ...
          SizedBox(height: 20,),
           ...
           InkWell(
            onTap: (){
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context) => EliteBtAdd24ForElite(),));
                              },
             child: Padding(
