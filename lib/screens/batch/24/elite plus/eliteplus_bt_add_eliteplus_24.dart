...
class EliteBtAddForElitePlus24 extends StatefulWidget {
  const EliteBtAddForElitePlus24({Key? key}) : super(key: key);

  @override
  State<EliteBtAddForElitePlus24> createState() => _EliteBtAddForEliteState();
}

class _EliteBtAddForEliteState extends State<EliteBtAddForElitePlus24>with TickerProviderStateMixin {
            ...
            children: [
              Container(
                 child: Row(
                  ...
                  children: [
                   Text("Your Batch" , style: TextStyle(
                    fontSize: 20, 
