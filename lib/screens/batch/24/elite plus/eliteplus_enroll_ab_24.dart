...
class ElitePlusBt24 extends StatefulWidget {
  ElitePlusBt24({Key? key}) : super(key: key);

  @override
  State<ElitePlusBt24> createState() => _EliteBt23State();
}

class _EliteBt23State extends State<ElitePlusBt24> {
  // int currentStep = 0;
  // dynamic titleName ;
          ...
          SizedBox(height: 20,),
           ...
           InkWell(
            onTap: (){
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context) => EliteBtAddForElitePlus24(),));
                              },
             child: Padding(
