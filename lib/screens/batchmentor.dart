...
class Batchmentor extends StatefulWidget {
  Batchmentor({Key? key}) : super(key: key);

  @override
  State<Batchmentor> createState() => _BatchmentorState();
}

class _BatchmentorState extends State<Batchmentor> {
  // int currentStep = 0;
  // dynamic titleName ;
