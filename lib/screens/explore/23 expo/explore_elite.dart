...
class ExploreElite extends StatefulWidget {
  const ExploreElite({super.key});

  @override
  State<ExploreElite> createState() => _ExploreState();
}

class _ExploreState extends State<ExploreElite> with SingleTickerProviderStateMixin{
