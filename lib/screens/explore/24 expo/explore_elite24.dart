...
class ExploreElite24 extends StatefulWidget {
  const ExploreElite24({super.key});

  @override
  State<ExploreElite24> createState() => _ExploreState();
}

class _ExploreState extends State<ExploreElite24> with SingleTickerProviderStateMixin{
