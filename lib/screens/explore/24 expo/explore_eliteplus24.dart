...
class ExploreElitePlus24 extends StatefulWidget {
  const ExploreElitePlus24({super.key});

  @override
  State<ExploreElitePlus24> createState() => _ExploreState();
}

class _ExploreState extends State<ExploreElitePlus24> with SingleTickerProviderStateMixin{
                        ...
                        child: Padding(
                          ...
                          child: Column(
                           crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                                    Text("Elite + 2024 Batch ", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),), 
                              SizedBox(height: 30,),
