...
class EliteGrAddForElite extends StatefulWidget {
  const EliteGrAddForElite({Key? key}) : super(key: key);

  @override
  State<EliteGrAddForElite> createState() => _EliteBtAddForEliteState();
}

class _EliteBtAddForEliteState extends State<EliteGrAddForElite>with TickerProviderStateMixin {
        ...
        child: Padding(
          ...
          Expanded(
            child: TabBarView(controller: _tabController, children: [
              ...
              //   children: [
              //     Align(
              //         alignment: Alignment.center, child: Chatscn())
              //   ],
              // )
