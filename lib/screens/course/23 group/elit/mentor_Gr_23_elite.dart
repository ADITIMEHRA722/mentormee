...
import 'package:mentormee/screens/course/23%20group/elit/elite_enroll_ab.dart';
...
class MentorGr23Elite extends StatelessWidget {
  MentorGr23Elite({Key? key}) : super(key: key);
          ...
          children: <Widget>[
            ...
            // ! title  and Subtitle for
                ...
                Container(
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: ((context) =>EliteGr23())));
                    },
