...
import 'package:mentormee/screens/course/23%20group/elit/elit_gr_add_elite.dart';
...
class EliteGr23 extends StatefulWidget {
  EliteGr23({Key? key}) : super(key: key);

  @override
  State<EliteGr23> createState() => _EliteGr23State();
}

class _EliteGr23State extends State<EliteGr23> {
  // int currentStep = 0;
  // dynamic titleName ;
          ...
          SizedBox(height: 20,),
           ...
           InkWell(
            onTap: (){
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context) => EliteGrAddForElite(),));
                              },
             child: Padding(
