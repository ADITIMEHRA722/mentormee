...
import 'package:mentormee/screens/course/24%20group/elite%20plus/pay_now_gr_eliteplus_24.dart';
import 'package:mentormee/screens/course/24%20group/elite/pay_now_Gr_24_elite.dart';
...
import 'package:mentormee/screens/explore/24%20expo/explore_eliteplus24.dart';
...
class CourceDetails24 extends StatefulWidget {
  const CourceDetails24({super.key});

  @override
  State<CourceDetails24> createState() => _CourceDetails24State();
}

class _CourceDetails24State extends State<CourceDetails24>with TickerProviderStateMixin {
  @override
                      ...
                      style: TextStyle(
                          ...
                          children: [
                            ...
                            InkWell(
                             ...
                             InkWell(
                              onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: ((context) => PayNowGr24elite())));
                              },
                               child: Container(
                                height: 40, 
                                width: 120,
                    ...
                    Text("12999 ₹", 
                      ...
                      style: TextStyle(
                          ...
                          children: [
                            ...
                            InkWell(
                               onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: ((context) => ExploreElitePlus24())));
                              },
                              child: Container(
                                height: 40, 
                                width: 120,
                             ...
                             InkWell(
                               onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: ((context) => PayNowGr24elitePlus())));
                              },
                               child: Container(
                                height: 40, 
                                width: 120,
