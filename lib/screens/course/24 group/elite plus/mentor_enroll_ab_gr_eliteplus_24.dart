...
import 'package:mentormee/screens/batch/24/elite%20plus/eliteplus_enroll_ab_24.dart';
import 'package:mentormee/screens/course/24%20group/elite%20plus/eliteplus_enroll_ab_gr_24.dart';
...
class MentorGr24ElitePlus extends StatelessWidget {
  MentorGr24ElitePlus({Key? key}) : super(key: key);
          ...
          children: <Widget>[
            ...
            // ! title  and Subtitle for
                ...
                Container(
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: ((context) =>ElitePlusGr24())));
                    },
