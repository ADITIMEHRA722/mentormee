...
import 'package:mentormee/screens/batch/24/elite%20plus/eliteplus_bt_add_eliteplus_24.dart';
import 'package:mentormee/screens/batch/course_details_23_fr_bt.dart';
import 'package:mentormee/screens/course/24%20group/elite%20plus/eliteplus_gr_add_eliteplus_24.dart';
...
class ElitePlusGr24 extends StatefulWidget {
  ElitePlusGr24({Key? key}) : super(key: key);

  @override
  State<ElitePlusGr24> createState() => _EliteBt23State();
}

class _EliteBt23State extends State<ElitePlusGr24> {
  // int currentStep = 0;
  // dynamic titleName ;
          ...
          SizedBox(height: 20,),
           ...
           InkWell(
            onTap: (){
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context) => EliteGrAddForElitePlus24(),));
                              },
             child: Padding(
