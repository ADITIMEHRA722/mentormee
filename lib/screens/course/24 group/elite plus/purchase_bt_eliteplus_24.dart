...
import 'package:mentormee/screens/course/24%20group/elite%20plus/mentor_enroll_ab_gr_eliteplus_24.dart';
...
class PurchaseGrElitePlus24 extends StatefulWidget {
  PurchaseGrElitePlus24({Key? key}) : super(key: key);

  @override
  State<PurchaseGrElitePlus24> createState() => _PurchaseBtEliteState();
}

class _PurchaseBtEliteState extends State<PurchaseGrElitePlus24> {
  @override
        ...
        child: Column(
          children: [
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => MentorGr24ElitePlus()));
              },
              child: Container(
                height: 55,
                width: 310,
