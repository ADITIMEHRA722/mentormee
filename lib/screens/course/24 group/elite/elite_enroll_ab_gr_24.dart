...
import 'package:mentormee/screens/batch/24/elite/elite_bt_add24_elite.dart';
import 'package:mentormee/screens/batch/course_details_23_fr_bt.dart';
import 'package:mentormee/screens/course/24%20group/elite/elite_Gr_add24_elite.dart';
...
class EliteGr24 extends StatefulWidget {
  EliteGr24({Key? key}) : super(key: key);

  @override
  State<EliteGr24> createState() => _EliteBt23State();
}

class _EliteBt23State extends State<EliteGr24> {
  // int currentStep = 0;
  // dynamic titleName ;
          ...
          SizedBox(height: 20,),
           ...
           InkWell(
            onTap: (){
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context) => EliteGrAdd24ForElite(),));
                              },
             child: Padding(
