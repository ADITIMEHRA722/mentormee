...
import 'package:mentormee/screens/batch/24/elite/elite_enroll_ab_24.dart';
import 'package:mentormee/screens/course/24%20group/elite/elite_enroll_ab_gr_24.dart';
...
class MentorGr24Elite extends StatelessWidget {
  MentorGr24Elite({Key? key}) : super(key: key);
          ...
          children: <Widget>[
            ...
            // ! title  and Subtitle for
                ...
                Container(
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: ((context) =>EliteGr24())));
                    },
