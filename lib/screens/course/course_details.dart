...
import 'package:mentormee/screens/course/23%20group/elit%20plus/pay_now_Gr_eliteplus.dart';
import 'package:mentormee/screens/course/23%20group/elit/pay_now_Gr.dart';
import 'package:mentormee/screens/course/23%20group/elit/purchase_gr.dart';
...
class CourceDetails extends StatefulWidget {
  const CourceDetails({super.key});

  @override
  State<CourceDetails> createState() => _CourceDetailsState();
}

class _CourceDetailsState extends State<CourceDetails>with TickerProviderStateMixin {
  @override
                                       ...
                                       style: TextStyle(
                                           ...
                                           children: [
                                             ...
                                             InkWell(
                                              ...
                                              InkWell(
                                               onTap: (){
                                                 Navigator.push(context, MaterialPageRoute(builder: ((context) => PayNowGr23elite() )));
                                               },
                                                child: Container(
                                                 height: 40, 
                                                 width: 120,
                                       ...
                                       style: TextStyle(
                                           ...
                                           children: [
                                             ...
                                             InkWell(
                                              ...
                                              InkWell(
                                               onTap: (){
                                                 Navigator.push(context, MaterialPageRoute(builder: ((context) => PayNowGr23elitePlus())));
                                               },
                                                child: Container(
                                                 height: 40, 
                                                 width: 120,
